...
ECHO|SET /P=""%IDE_HOME:\=/%/plugins/android/lib/*;"" >> "%ARG_FILE%"
ECHO|SET /P=""%IDE_HOME:\=/%/plugins/android/resources/*;"" >> "%ARG_FILE%"
ECHO|SET /P=""%IDE_HOME:\=/%/plugins/java/lib/java-api.jar;"" >> "%ARG_FILE%"
ECHO|SET /P=""%IDE_HOME:\=/%/plugins/java/lib/java-frontback.jar;"" >> "%ARG_FILE%"
ECHO|SET /P=""%IDE_HOME:\=/%/plugins/java/lib/java-impl.jar;"" >> "%ARG_FILE%"
ECHO|SET /P=""%IDE_HOME:\=/%/plugins/java/lib/resources.jar;"" >> "%ARG_FILE%"
ECHO|SET /P=""%IDE_HOME:\=/%/plugins/java/lib/java_resources_en.jar;"" >> "%ARG_FILE%"
ECHO|SET /P=""%IDE_HOME:\=/%/plugins/java/lib/modules/*;"" >> "%ARG_FILE%"
